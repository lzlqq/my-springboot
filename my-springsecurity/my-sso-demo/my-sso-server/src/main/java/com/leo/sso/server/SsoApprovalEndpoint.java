...
/**
 * 
 * 这个类的作用是自动提交授权那一步，让用户不用手动点击授权
 * 参考{@link WhitelabelApprovalEndpoint} 的实现，Spring优先使用@RestController注解
 * 声明的Controller，其次再处理@FrameworkEndpoint注解的接口
 */
@RestController
